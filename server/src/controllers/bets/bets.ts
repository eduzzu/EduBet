...
export const generateBetOdds = async(req: Request, res: Response) => {
    try{
        const {
            homeWinProbability,
            drawProbability,
            awayWinProbability,
            homeOrDrawProbability,
            awayOrDrawProbability,
            noDrawProbability,
            ggProbability,
            nggProbability,
            under1GoalProbability,
            under2GoalsProbability,
            under3GoalsProbability,
            under4GoalsProbability,
            under5GoalsProbability,
            over1GoalProbability,
            over2GoalsProbability,
            over3GoalsProbability,
            over4GoalsProbability,
            over5GoalsProbability,
            under1GoalHomeProbability,
            under2GoalsHomeProbability,
            under3GoalsHomeProbability,
            under4GoalsHomeProbability,
            under5GoalsHomeProbability,
            over1GoalHomeProbability,
            over2GoalsHomeProbability,
            over3GoalsHomeProbability,
            over4GoalsHomeProbability,
            over5GoalsHomeProbability,
            under1GoalAwayProbability,
            under2GoalsAwayProbability,
            under3GoalsAwayProbability,
            under4GoalsAwayProbability,
            under5GoalsAwayProbability,
            over1GoalAwayProbability,
            over2GoalsAwayProbability,
            over3GoalsAwayProbability,
            over4GoalsAwayProbability,
            over5GoalsAwayProbability,
        } = req.body;
